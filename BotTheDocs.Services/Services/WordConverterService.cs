...
namespace SupportSearch.Helper
{
    ...
    {
        protected SupportSearch.Common.Interfaces.ISupportBlobUpload _blobUploader;

        protected SupportSearch.Common.Interfaces.ISupportKeyWords _mlKeyWordHelper;

        public WordConverterService(SupportSearch.Common.Interfaces.ISupportBlobUpload blobUploader, SupportSearch.Common.Interfaces.ISupportKeyWords keyWordsHelper)
        {
                    ...
                    if (docElem.GetType() == typeof(DocumentFormat.OpenXml.Wordprocessing.Table))
                    {
                        ...
                        foreach (Run runElem in docElem.Descendants<Run>())
                        {
                            ...
                            foreach (DocumentFormat.OpenXml.Drawing.Blip b in runElem.Descendants<DocumentFormat.OpenXml.Drawing.Blip>())
                            {
                                ...
                                string fileName = $"image-{wordDto.DocumentName}-{b.Embed.Value}";
