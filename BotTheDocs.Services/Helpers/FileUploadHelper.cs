...
{
    [Serializable]
    public class FileUploadHelper : SupportSearch.Common.Interfaces.ISupportBlobUpload
    {
        protected string rootFilePath = System.Environment.GetEnvironmentVariable("FilePath");
        ...
        public void UploadDocHtml(string Name, string HtmlContent, string KeyWords, string TextContent)
        {
            ...
            System.IO.File.WriteAllText(htmlPath + "\\" + Name, HtmlContent);
        }
        ...
        public void UploadDocMarkdown(string Name, String MdContent, string KeyWords, string TextContent)
        {
            ...
            System.IO.File.WriteAllText(mdPath + "\\" + Name, MdContent);
        }
